...
module.exports = function () {
  return {
    converters: [[function (node) {
      ...
      var headingNodeChildren = _utils2.default.getChildren(node);
      var headingText = headingNodeChildren.map(function (node) {
      ...
      var headingTextId = headingText.trim().replace(/\s+/g, '-');
      return _react2.default.createElement(_utils2.default.getTagName(node), _extends({
        ...
        'span',
        { key: 'title' },
        headingNodeChildren.map(function (child) {
